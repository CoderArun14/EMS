...
const Newtask = ({elm}) => {
  return (
    <>
     <div className=' item rounded bg-secondary p-2'>
      <div className='d-flex justify-content-between'>
        ...
        <div className='d-flex justify-content-between'>
          <button className='btn bg-success m-0 px-2 fw-bold  ' style={{fontSize:'11px',width:'100px,',height:'40px' }}>Accept Task</button>
