...
const App = () => {
  ...
  function my(){
    fetch("https://dummyjson.com/products").then((myData)=> myData.json()).then((hereData)=> setvalue(hereData.products))
...
useEffect(()=>{
 ...
 my()
  ...
  const search=()=>{
console.log(value);
  let newfilter= value.filter(info => info.todo.toLowerCase().includes((value).toLowerCase()))
  setfilter(newfilter)
  // console.logn(newfilter)
  ...
  return (
    <>
      <input type="text"  placeholder="Type UserID or ID" />
