...
//       let hereData = await myData.json()
//       setData(hereData.products)

//   }
 function my(){
       fetch("https://dummyjson.com/products").then((myData)=> myData.json()).then((hereData)=> setData(hereData.products))
  ...
  return (
    ...
    {num}
    <input type="text" />
    <button onClick={()=>setnum(num + 1)}>search</button>
    <div className="row">
        {data.map(elm =><div className="col-3">
            <Card elm={elm}/>
        </div>)}
    </div>
    </>
